...
- Skladnia wewnatrz gitignore
  ...
  + ignoruj wszystkie pliki i katalogii z wyjatkiem pliku 'module.py'
    ```
    *
    !module.py
    ```
...
Stage to poczelania. Tutaj przechowuje sie tymczasowo modfikacje przez commit-em.
...
- modyfikacja do komentarza w ostatniej zmianie
  ...
  git commit --amend
  ```
  W chodzę w VIM w tryb umozliwiajacy zmiany i poprawiam pierwsza linijke gdzie jest komentarz. Naciskam <esc> i potem :wq i <enter> 
